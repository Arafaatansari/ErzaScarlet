...
from ErzaScarlet import logging
from ErzaScarlet import pbot as _client  # pylint: disable=unused-import
...
class Message(RawMessage):
    """ Modded Message Class For Erza """
    def __init__(self,
                 client: Union['_client.Erza', '_client.ErzaBot'],
    ...
    @classmethod
    def parse(cls, client: Union['_client.Erza', '_client.ErzaBot'],
    ...
    @property
    def client(self) -> Union['_client.Erza', '_client.ErzaBot']:
        """ returns client """
        return self._client
