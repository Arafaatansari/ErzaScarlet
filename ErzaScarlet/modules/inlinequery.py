...
from ErzaScarlet import dispatcher, TMDBAPI
from ErzaScarlet.helper_extra import strings as st
from ErzaScarlet.helper_extra.parsedata import article
from ErzaScarlet.helper_extra import keyboard
from ErzaScarlet.modules.sql import users_sql as sql
...
AINLINE_HANDLER = InlineQueryHandler(inlinequery)
dispatcher.add_handler(AINLINE_HANDLER)
