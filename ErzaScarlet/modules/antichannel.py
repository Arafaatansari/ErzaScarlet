import os
from ErzaScarlet.modules.sql_extended.anitchannel_mongo import db
from pyrogram import Client, filters
from ErzaScarlet import pbot as Aryza
...
@Aryza.on_message(filters.command(["channelban"]) & filters.group)
...
@Aryza.on_message(filters.command(["channelunban"]) & filters.group)
