...
import ErzaScarlet.modules.strings as s
import ErzaScarlet.modules.sql_extended.database as sql
...
def kstats(update, context):
    ...
    dispatcher.add_handler(CommandHandler('steal', steal, pass_args=True))
    dispatcher.add_handler(CommandHandler('stealpack', stealpack, pass_args=True))
    dispatcher.add_handler(CommandHandler('delsticker', delsticker))
    dispatcher.add_handler(CommandHandler('delpack', delpack))
    dispatcher.add_handler(CommandHandler('setposition', setposition, pass_args=True))
    dispatcher.add_handler(CommandHandler('switch', switch, pass_args=True))
    dispatcher.add_handler(CommandHandler('mypacks', mypacks))
    dispatcher.add_handler(CommandHandler('kstats', kstats))
